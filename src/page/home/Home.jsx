...
import Volleyball from "../../assets/homePage/volleyball.jpg";
    ...
    <>
      ...
      <main>
        <section className="mt-40">
          ...
          <h5 className="text-xl text-center font-bold dark:text-white pt-6">
        ...
        <section className="relative flex items-center justify-center my-16">
          <div className="w-full md:w-3/4 p-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-10">
              <div className="w-full text-center p-6 bg-gray-200 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">
                  Sport Hub មានការ update ព័ត៏មានជារាងរាល់ថ្ងៃ។
                </p>
              </div>
              <div className="w-full text-center p-6 bg-gray-200 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <div className="mb-2 text-[28px] tracking-tight text-gray-900 dark:text-white text-center">
              ...
              <div className="w-full text-center p-6 bg-gray-200 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">
                  Sport Hub បង្កើនភាពងាយ ស្រួល តាមវិធីសាស្ត្រច្រើន។
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative mt-5 bg-[#172554] w-full md:w-[573px] h-auto md:h-[351px] p-5 rounded-lg text-white">
              ...
              <div className="flex flex-col py-5 px-10 gap-5 md:gap-12">
                ...
                <div className="flex gap-4 md:gap-5 items-center">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl">Messi</h3>
                    <p className="text-sm md:text-base">
                      អ្នកគាំទ្រកីឡាបាល់ទាត់
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative mt-5 bg-black w-full md:w-[573px] h-auto md:h-[351px] p-5 rounded-lg text-white">
              ...
              <div className="flex flex-col py-5 px-10 gap-5 md:gap-5">
                ...
                <div className="flex gap-4 md:gap-5 items-center">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl">Ronaldo</h3>
                    <p className="text-sm md:text-base">
                      អ្នកគាំទ្រកីឡាបាល់ទាត់
                    </p>
                  </div>
